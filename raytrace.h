...
class Material
{
 public:
    ...
    Material()  : Kd(Vector3f(1.0, 0.5, 0.0)), Ks(Vector3f(1,1,1)), Kt(Vector3f(0, 0, 0)), alpha(1.0), IOR(1.f), texid(0) {}
    Material(const Vector3f d, const Vector3f s, const float a, const Vector3f t, const float ior)
        : Kd(d), Ks(s),  Kt(t), alpha(a), IOR(ior), texid(0) {}
    Material(const Vector3f d, const Vector3f s, const float a)
        : Kd(d), Ks(s), Kt(Vector3f(0,0,0)), alpha(a), IOR(1.f), texid(0) {}
    Material(Material& o) { Kd = o.Kd;  Ks = o.Ks; Kt = o.Kt; IOR = o.IOR; alpha = o.alpha;  texid = o.texid; }
